...
require_once EXCELPATH.'Format.php';
require_once EXCELPATH.'BIFFwriter.php';
require_once EXCELPATH.'Worksheet.php';
require_once EXCELPATH.'Parser.php';
require_once EXCELPATH.'OLE/PPS/Root.php';
require_once EXCELPATH.'OLE/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @return mixed reference to a worksheet object on success, PEARS_Error
    *               on failure
    */
