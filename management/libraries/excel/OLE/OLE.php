...
//require_once(EXCELPATH.'PEARS.php');
require_once(EXCELPATH.'OLE/PPS.php');
...
class OLE extends PEARS
{
    ...
    */
    ...
    {
        if (strlen($string) != 8) {
            return new PEARS_Error("Expecting 8 byte string");
        }
