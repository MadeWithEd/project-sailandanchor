...
include($_SERVER['DOCUMENT_ROOT']."/management/modules/content/ajax/image_functions.php"); 									#
...
if ($_POST["upload"]=="Upload") { 
	...
	if (strlen($error)==0){
		...
		if (isset($_FILES['image']['name'])){
			...
			echo "success|".str_replace($_SERVER["DOCUMENT_ROOT"],"",$large_image_location)."|".getWidth($large_image_location)."|".getHeight($large_image_location);
		}
	}else{
		echo "error|".$error;
	}
...
if ($_POST["save_thumb"]=="Save Thumbnail") { 
	...
	echo "success|".str_replace($_SERVER["DOCUMENT_ROOT"],"",$large_image_location)."|".str_replace($_SERVER["DOCUMENT_ROOT"],"",$thumb_image_location);
	$_SESSION['random_key']= "";
	$_SESSION['user_file_ext']= "";
}
