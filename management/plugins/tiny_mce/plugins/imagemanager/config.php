...
include_once(FCPATH."core/config.inc.php");
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $CONFIG['site']['site_path'].$CONFIG['site']['user_uploads'].'/mediamanager/images'; // absolute or relative from this script path, required.
