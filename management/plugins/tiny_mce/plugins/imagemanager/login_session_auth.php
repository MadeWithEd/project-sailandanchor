...
include_once(FCPATH."core/config.inc.php");
	...
	if(session_is_registered($CONFIG['session']['name'])) {
			...
			$_SESSION['user'] = "login";
	header("location: /management/plugins/tiny_mce/plugins/imagemanager/index.php?type=im&amp;page=index.html");
	exit;
	}
	...
	$msg = "";
	$username = "demo";
	$password = "singer"; // Change the password to something suitable
