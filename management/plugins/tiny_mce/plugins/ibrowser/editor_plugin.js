...
tinyMCE.importPluginLanguagePack('ibrowser', 'pt_br,en,no');
...
function TinyMCE_ibrowser_getControlHTML(control_name) {
	switch (control_name) {
		case "ibrowser":
			return '<a class="mceTiledButton mceButtonNormal" id="{$editor_id}_ibrowser" href="javascript:tinyMCE.execInstanceCommand(\'{$editor_id}\',\'mceBrowseImage\');"><img id="{$editor_id}_ibrowser23" src="{$pluginurl}/images/ibrowser.gif" title="{$lang_ibrowser_desc}" width="20" height="20"></a>';
	}
