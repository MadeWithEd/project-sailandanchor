...
$_SESSION['tinybrowser']['sessioncheck'] = 'usersession'; // name of session variable to check
...
$_SESSION['tinybrowser']['path']['root'] = '/images/mediamanager/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/images/mediamanager/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$_SESSION['tinybrowser']['path']['media'] = '/images/mediamanager/media/'; // Media files location
$_SESSION['tinybrowser']['path']['file']  = '/images/mediamanager/files/'; // Other files location
